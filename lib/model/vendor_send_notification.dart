...
class VendorNotificationResponse {
  ...
  factory VendorNotificationResponse.fromJson(String str) =>
      VendorNotificationResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory VendorNotificationResponse.fromMap(Map<String, dynamic> json) =>
      VendorNotificationResponse(
        success: json["success"] == null ? null : json["success"],
        message: json["message"] == null ? null : json["message"],
        data: json["data"] == null
            ? null
            : List<VendorNotificationData>.from(
                json["data"].map((x) => VendorNotificationData.fromMap(x))),
      );
...
class VendorNotificationData {
  ...
  factory VendorNotificationData.fromJson(String str) =>
      VendorNotificationData.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory VendorNotificationData.fromMap(Map<String, dynamic> json) =>
      VendorNotificationData(
...
class Details {
  ...
  factory Details.fromMap(Map<String, dynamic> json) => Details(
        ...
        vendorCommission: json["vendor_commission"] == null
            ? null
            : json["vendor_commission"],
        ownerMobile: json["owner_mobile"] == null ? null : json["owner_mobile"],
        address: json["address"] == null ? null : json["address"],
        subCatId: json["sub_cat_id"] == null ? null : json["sub_cat_id"],
        subCatCommission: json["sub_cat_commission"] == null
            ? null
            : json["sub_cat_commission"],
        ...
        ownerSign: json["owner_sign"] == null
            ? null
            : OwnerSign.fromMap(json["owner_sign"]),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "sub_cat_commission":
            subCatCommission == null ? null : subCatCommission,
